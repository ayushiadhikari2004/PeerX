...
echo.
echo ============================================
echo   Starting PeerX Peer Network Test
echo ============================================
echo.
...
start "PeerX Peer 1" cmd /k "set PORT=5000 && set PEER_PORT=5001 && node server.js"

timeout /t 2 /nobreak >nul

echo Starting Peer 2 (Port 5100, UDP 5101)...
start "PeerX Peer 2" cmd /k "set PORT=5100 && set PEER_PORT=5101 && node server.js"

timeout /t 2 /nobreak >nul

echo Starting Peer 3 (Port 5200, UDP 5201)...
start "PeerX Peer 3" cmd /k "set PORT=5200 && set PEER_PORT=5201 && node server.js"
